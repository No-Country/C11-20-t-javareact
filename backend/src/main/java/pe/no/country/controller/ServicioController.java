...
public class ServicioController {
    ...
    public ResponseEntity<?> create(@RequestBody Servicio servicioEnt) {
        ...
        Servicio servicio = new Servicio(servicioEnt.getNombreservicio(), servicioEnt.getDescripcion(), servicioEnt.getCosto());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody Servicio servicioEnt) {
        ...
        servicio.setNombreservicio(servicioEnt.getNombreservicio());
        servicio.setDescripcion(servicioEnt.getDescripcion());
        servicio.setCosto(servicioEnt.getCosto());
        servicioService.save(servicio);
