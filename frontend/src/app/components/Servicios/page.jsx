    ...
    return (
      <main className="bg-blue-50 grid grid-cols-10 gap-2 min-h-screen p-2">
        ...
        <div className="bg-slate-200 rounded-sm col-span-8 border-purple-950 w-auto px-4 py-4"> 
          ...
          <div className="w-auto bg-white border">
                ...
                <tbody>
                  {
                    servicios?.map(servicio => (
                      <tr key={servicio.id} className="grid grid-cols-12">
                        <td className="border border-slate-200 col-span-3 px-2 py-1.5 text-left text-sm">{servicio.title}</td>
                        <td className="border border-slate-200 col-span-5 px-2 py-1.5 text-left text-sm">{servicio.description}</td>
                        <td className="border border-slate-200 col-span-2 px-2 py-1.5 text-left text-sm">${servicio.price}</td>
                        ...
                        <td className="border border-slate-200 col-span-1 px-2 py-1.5 text-left text-sm flex flex-row justify-center gap-1.5">
                          <Link href='/components/Servicios/ActualizarServicio/[id]' as={`/components/Servicios/ActualizarServicio/${servicio.id}`}>
                          ...
                          <Link href="/components/Servicios/EliminarServicio/[id]" as={`/components/Servicios/EliminarServicio/${servicio.id}`}>
