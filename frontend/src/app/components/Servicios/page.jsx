                ...
                <tbody>
                  {
                    servicios?.map(servicio => (
                      <tr key={servicio.id} className="grid grid-cols-12">
                        ...
                        <td className="border border-slate-200 col-span-1 px-2 py-1.5 text-left text-sm">Activo</td>
                        <td className="border border-slate-200 col-span-1 px-2 py-1.5 text-left text-sm flex flex-row justify-center gap-1.5">
                          <Link href='/components/Servicios/Actualizar/[id]' as={`/components/Servicios/ActualizarServicio/${servicio.id}`}>
