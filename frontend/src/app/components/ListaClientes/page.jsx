...
function ListaClientes() {
  ...
  return (
    ...
    <div className='col-span-8  mx-auto mt-7'>  
      <h1 className='mx-auto text-3xl font-bold font-serif text-black'>Tabla de Clientes:</h1>
      <br />
      <table class=" inline-block rounded-lg border shadow-2xl bg-white text-black">
        <thead className='bg-gray-200 rounded-t-xl '>
          <tr className='border'>
            ...
            <td className='border px-2 font-serif font-bold'>Nombre</td>
            ...
            <td className='border font-serif text-center font-bold text-sm'>Tipo documento</td>
            <td className='border font-serif text-center font-bold'>Número documento</td>
        ...
        <tbody className='bg-white'>
          ...
          <tr className='border bg-white'>
              ...
              <th className='font-serif'>No hay</th>
              <th className='font-serif'>clientes</th>
              <th className='font-serif pl-1'>registrados por</th>
              <th className='font-serif text-left'>  ahora</th>
              <th ></th>
              <th ></th>
              ...
              listaClientes?.map(c => {
                return (
                  <tr className='bg-white border-b-gray-300 border-b shadow-2xl'>
                    ...
                    <td className='border-r-gray-300 text-xs text-center px-4'>{c.idcliente}</td>
                    ...
                    <td className='border-r-gray-300 text-xs text-center px-4'>{c.tipodocumento}</td>
                    <td className='border-r-gray-300 text-xs text-center px-4'>{c.numerodocumento}</td>
                    <td className='text-xs text-center px-4'>$ {c.telefono}</td>
                    <td className='text-xs text-center px-4'>
                      <button 
                      onClick={(e) => borrarCliente(e, c.idcliente)}
