...
function ListaCitas() {
  ...
  return (
    ...
    <div className='col-span-8 grid grid-rows-4 mx-auto mt-7'>
       {
        id == 1? 
       <h1 className='mx-auto text-2xl font-bold font-serif -m-[20px] text-black'>Ana Lucia Jhonsson Tagle</h1>
       :
       id == 2? 
       <h1 className='mx-auto text-2xl font-bold font-serif -m-[20px] text-black'>Camila Alejandra Aragon</h1>
       :
       id == 3? 
       <h1 className='mx-auto text-2xl font-bold font-serif -m-[20px] text-black'>Mario Guzman Torres</h1>
        :
       <h1 className='mx-auto text-2xl font-bold font-serif -m-[20px] text-black'>Miguel Smith Romero</h1>
       }
       
      <h1 className='mx-auto text-3xl font-bold font-serif -mt-[135px] text-black'>Lista De Citas</h1>

      <table class="-mt-[225px] inline-block rounded-lg border shadow-2xl bg-white text-black">
        <thead className='bg-gray-200 rounded-t-xl '>
          <tr className='border'>
            <td className='border font-serif text-center font-bold text-black'>Cliente</td>
            <td className='border px-2 font-serif font-bold text-black'>DNI / CC / TI</td>
            <td className='border font-serif text-center font-bold text-black'>Correo</td>
            <td className='border font-serif text-center font-bold text-black'>Contacto</td>
            <td className='border font-serif text-center font-bold text-sm text-black'>Fecha registrada</td>
            <td className='border font-serif text-center font-bold text-black'>Estado</td>
            <td className='border font-serif text-center font-bold text-black'>Servicio</td>
            <td className='font-serif text-center font-bold text-black'>Costo</td>
            <td className='font-serif text-center font-bold' text-black>Cerrar</td>
          </tr>
        </thead>
