    ...
    <main className="bg-slate-100 grid grid-cols-10 gap-2 min-h-screen p-2">
      ...
      <div className='col-span-8 grid grid-cols-3 mx-auto mt-7'>
          ...
          <div>
            ...
            <div class=" relative w-64 mx-auto mt-[30px]">
            ...
            <div class=" relative w-64 mx-auto mt-5">
              <p className='font-bold'>Serivicio:</p>
                <select 
                  name='servicio'
                  value={servicio}
                  onChange={(e) => setServicio(e.target.value)}
                  class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-20 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
