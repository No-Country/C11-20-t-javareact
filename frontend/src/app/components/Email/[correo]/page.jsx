...
const ContactUs = () => {
  ...
  return (
    ...
    <form ref={form} onSubmit={sendEmail}>
      <h5 className='font-bold text-3xl font-serif text-black'>Confirmar cita:</h5>
      <br />
      <br />
      <label className='font-bold font-serif text-black'>Nombre:</label>
      <input 
        type="text" 
        className='w-[450px] border rounded  py-1 text-black' 
        name="user_name" 
        value={name === ""? cita.cliente?.nombre + ' ' + cita.cliente?.apellido : cita.cliente?.nombre !== ''? name : ''  } 
        onChange={(e) => setName(e.target.value)}
      />
      <br />
      <label className='font-bold font-serif text-black'>Correo:</label>
      <input 
        type="email" 
        className='w-[450px] border rounded  py-1 text-black' 
        name="user_email" 
      ...
      />
      <br />
      <label className='font-bold font-serif text-black'>Mensaje:</label>
      <textarea name="message" className='w-[450px] h-[150px] border rounded text-black'/><br />
      <input 
        type="submit" 
