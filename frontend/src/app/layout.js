...
const authData = () => {
  if (typeof window !== 'undefined') {
    sessionStorage.setItem("token", "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbkBnbWFpbC5jb20iLCJyb2xlcyI6WyJST0xFX0FETUlOIiwiUk9MRV9VU0VSIl0sImlhdCI6MTY4NjA2MTQ0MiwiZXhwIjoxNjg2MDY1MDQyfQ.nzMZOKUgOqdifAgmiOHohXakXFFF6IBm_v7qHqxYC_jsP7zobuZWc2ofqvGvn-MOY3Koehz4lBdSdZyoG1Q0jw");
    sessionStorage.setItem("token1","eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbkBnbWFpbC5jb20iLCJyb2xlcyI6WyJST0xFX0FETUlOIiwiUk9MRV9VU0VSIl0sImlhdCI6MTY4NjA1NzY1MywiZXhwIjoxNjg2MDYxMjUzfQ.MCxMOKEwR0U0YPddy95UxNdSkzinn6vsPF1-gW3ZCB8racZH-EmajWF2mx3_eriz_9RLvBdWu29983WbKr5vpQ")
    sessionStorage.setItem("role", 'ROLE_ADMIN');
    sessionStorage.setItem("userId", 'Administrador');
